---
title: "Deployment"
description: "Run Milford with Docker or directly with Node."
---
...
Put `milford.config.yaml` and a `flows/` directory next to `docker-compose.yml`, then set your keys:

```bash
export MILFORD_TOKEN=change-me
...
```bash
export MILFORD_MCP_TOKEN=change-me
