...
You can expect a first reply within a few days. Loage is at an early version and only the latest release receives fixes.

## What to keep in mind when running Loage
